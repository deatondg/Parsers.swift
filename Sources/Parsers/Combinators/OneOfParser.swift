...
public func OneOf<O0, F0: Error, O1, F1: Error>(@ParserBuilder ps: () -> (Parser<O0, F0>?, Parser<O1, F1>?)) -> Parser<OneOf2<O0, O1>, AllOf2<OptionalFailure<F0>, OptionalFailure<F1>>> {
    let ps = ps()
        
    return OneOf2Parser(ps.0.orFailParser(), ps.1.orFailParser()).eraseToParser()
}
public func OneOf<O0, F0: Error, O1, F1: Error, O2, F2: Error>(@ParserBuilder ps: () -> (Parser<O0, F0>?, Parser<O1, F1>?, Parser<O2, F2>)) -> Parser<OneOf3<O0, O1, O2>, AllOf3<OptionalFailure<F0>, OptionalFailure<F1>, F2>> {
    let ps = ps()
        
    return OneOf3Parser(ps.0.orFailParser(), ps.1.orFailParser(), ps.2).eraseToParser()
}
